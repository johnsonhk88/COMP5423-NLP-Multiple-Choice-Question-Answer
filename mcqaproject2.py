# -*- coding: utf-8 -*-
"""
Created on Sun Apr 25 12:47:36 2021
...
class Race3(object):
    ...
    def __repr__(self):
        l = [
            ...
            "option_0: {}".format(self.ending_0),
            "option_1: {}".format(self.ending_1),
            "option_2: {}".format(self.ending_2),
            "option_3: {}".format(self.ending_3),
        ]
...
#Input Feature 1 can use RACE1 and RACE3
...
class MCQATrainModel:
    ...
    def convert_examples_to_features3(self, examples, tokenizer, max_seq_length):
        """Loads a data file into a list of `InputBatch`s.
        Args:
        ...
        for example_index, example in enumerate(examples):
            ...
            for ending_index, ending in enumerate(example.endings):
                ...
                self._truncate_seq_pair(context_tokens_choice,
    ...
    #can use for convert1 and convert3
